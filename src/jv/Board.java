...
public class Board {
    ...
    public Board() {
        ...
        cases = new Piece[]{
                ...
                new Piece("ROI", "noir"),
                new Piece("FOU", "noir"),
                new Piece("CAVALIER", "noir"), new Piece("TOUR", "noir"),
...
//        #    return
    ...
    boolean in_check(String couleur) {
        ...
        int pos = 0;// ??
        for (int i = 0; i < 64; i++) {
            if (cases[i].nom == "ROI" && cases[i].couleur == couleur) {
                pos = i;
                break;
            }
        }
...
//        boolean hist_roque_56, boolean hist_roque_63, boolean hist_roque_0, boolean hist_roque_7)
        ...
        // Replacing KING -----------------------------------------------
        else if (cases[pos1].nom == "ROI") {

            // White KING
            if (cases[pos1].couleur == "blanc") {
